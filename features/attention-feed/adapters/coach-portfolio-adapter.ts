 ...
 * Portfolio health is a Layer 1 domain metric — not Decision.action.
 */
  ...
  return [
    {
      ...
      analysis:
        summary.healthWhy ||
        summary.stabilityWhy ||
        'Portfolio Intelligence summarized your book (facts). Act synthesis is Decision Engine only.',
      evidence: [
